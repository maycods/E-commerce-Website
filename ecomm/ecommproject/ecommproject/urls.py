...
urlpatterns = [
    ...
    path("image/<int:pk>", views.get_image),
    path("products/categories/", views.get_categories),
    path("products/category/<str:category>", views.get_category),
    path("products/<str:category>", views.get_products_of_category),
