...
class promotion(models.Model):
    promo=models.PositiveIntegerField(validators=[MinValueValidator(10), MaxValueValidator(70)])
...
class Produit (models.Model):
    ...
    categoryp = models.ForeignKey("Category",on_delete=models.SET_NULL,null=True,related_name='+',blank=True)
    ratingt=models.PositiveIntegerField(validators=[MinValueValidator(1), MaxValueValidator(5)])
...
class order (models.Model): 
    ...
    qte= models.PositiveIntegerField(validators=[MinValueValidator(1)])#max value is the store attribue in produit   
